 ...
 **/
//#define mqtt_host "192.168.0.107" 	//This PC local IP
#define mqtt_host "192.168.0.100" 	//This PC local IP
//#define mqtt_host "192.168.2.100" 		//ROS Controller needs the PC to have this IP
//#define mqtt_host "150.214.140.206"	//Barebone Router IP
#define mqtt_port 1883 //9000
...
int main(int argc, char *argv[])
{
	...
	if (mosq)
	{
		...
		std::cout << "Connected to host " << mqtt_host << " via port " << mqtt_port << std::endl;
